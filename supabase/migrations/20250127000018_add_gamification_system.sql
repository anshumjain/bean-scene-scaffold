...
-- MVP gamification features for user acquisition

-- User stats table to track XP, levels, and basic metrics
...
-- User badges table to track earned achievements
...
-- Cafe visits table to track which cafes a user has visited
